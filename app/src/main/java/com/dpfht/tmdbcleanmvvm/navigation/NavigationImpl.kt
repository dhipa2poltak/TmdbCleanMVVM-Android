package com.dpfht.tmdbcleanmvvm.navigation
...
class NavigationImpl(private val navController: NavController, private val activity: AppCompatActivity): NavigationInterface {
